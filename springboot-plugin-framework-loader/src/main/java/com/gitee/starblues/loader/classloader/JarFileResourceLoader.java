 ...
 * @version 3.0.0
 */
public class JarFileResourceLoader extends AbstractResourceLoader{
    ...
    public JarFileResourceLoader(URL url)  throws Exception{
        super(url);
        this.jarInputStream = new JarInputStream(url.openStream());
    }

    public JarFileResourceLoader(URL url, JarInputStream jarInputStream)  throws Exception{
        super(url);
